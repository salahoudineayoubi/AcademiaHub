 ...
 * @author El Mysto
 */
public class Enseignant2 extends javax.swing.JFrame {
    Connection cn = JavaConnectDb.ConnecrDb();

    /**
     * Creates new form Enseignant2
     */
    public Enseignant2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enseignant2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Enseignant2().setVisible(true);
            }
        });
    }
